...
|----------|-------------|
| [tables.md](../docs/tables.md) | Complete table guide with examples |
| [table_guideline.md](../docs/table_guideline.md) | Quick reference for tables |
| [tips_and_tricks.md](../docs/tips_and_tricks.md) | Complete XanoScript syntax reference |
